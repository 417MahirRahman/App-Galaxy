    ...
    return (
        <div className='p-5 lg:p-10'>
            ...
            <div className='text-center space-y-3 md:flex md:justify-center md:gap-5'>
                <a className='btn btn-lg lg:btn-lg xl:btn-xl font-bold w-3/5 md:w-auto p-5 gap-3' href="https://play.google.com/store/games?hl=en" target='_blank'><img src={play_store} alt="" />Play Store</a>
                <a className='btn btn-lg lg:btn-lg xl:btn-xl font-bold w-3/5 md:w-auto p-5 gap-2' href="https://www.apple.com/app-store/" target='_blank'><img src={app_store} alt="" /> App Store</a>
            </div>
        </div>
    );
};
